...
import "./css/ApriliaFrontPage.css";
import { useState, useEffect } from "react";
function ApriliaFrontPage() {
  const Company = "Aprilia";
  ...
  return (
    <>
      <h1>Aprilia Motorsports</h1>
      <h1>Where design meet Perfection</h1>
      <div id="apriliaimage1"></div>
      <main>
        <p>
...
export default ApriliaFrontPage;
