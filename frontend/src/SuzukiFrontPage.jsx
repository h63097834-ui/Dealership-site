import "./css/SuzukiFrontPage.css";
import { Link } from "react-router-dom";
import { useState, useEffect } from "react";
function SuzukiFrontPage() {
  const Company = "Suzuki";
  ...
  return (
    <>
      <h1>Suzuki Motorsports</h1>
      <h1>Where design meets Perfection</h1>
      <div id="suzukiimage1"></div>
      <main>
        <p>
      ...
      <div id="suzukiimage2"></div>

      <h1>Our Product Lineup for Zuzuki</h1>
...
export default SuzukiFrontPage;
